...
public class JwtService {
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        extraClaims.put("picture", user.getProfilePictureUrl());
    ...
    private String buildToken(
        ...
        return Jwts.builder()
                ...
                .signWith(getSignInKey(), Jwts.SIG.HS256) // Correct way to sign
                .compact();
    }
    ...
    private Claims extractAllClaims(String token) {
        // --- THIS IS THE FIX ---
        // We use Jwts.parser() instead of Jwts.parserBuilder()
        return Jwts.parser()
    ...
    // Updated to return the proper SecretKey type
